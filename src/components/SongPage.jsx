          ...
          <div className="space-y-5">
            ...
            <div className="flex items-center justify-between pt-6">
              <div className="flex items-center gap-6">
                ...
                <button
                  onClick={togglePlay}
                  className="w-16 h-16 bg-gradient-to-br bg-blue-700 rounded-full flex items-center justify-center shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all"
                >
                  {playing ? (
                    <IoPause size={32} />
                  ) : (
